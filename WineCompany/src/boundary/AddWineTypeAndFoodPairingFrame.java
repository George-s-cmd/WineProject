...
public class AddWineTypeAndFoodPairingFrame extends JFrame {
    private static final long serialVersionUID = 1L;

    private JComboBox<String> cbWineType, cbDishName;
    private RoundedButton btnAdd, btnCancel;

    public AddWineTypeAndFoodPairingFrame() {
        setTitle("Add Wine-Food Pairing");
        setSize(800, 600);
        ...
        JLabel titleLabel = new JLabel("Adding Wine-Food Pairing");
        ...
        addInputField("Dish Name:", cbDishName, gbc, backgroundPanel, 2);
        ...
        // ✅ Button Actions
        btnAdd.addActionListener(e -> addPairing());
    ...
    private void addPairing() {
        try {
            ...
            boolean success = GeneralControl.getInstance().addWineFoodPairing(selectedWineType, selectedDish);

            if (success) {
                JOptionPane.showMessageDialog(this, "Wine-Food Pairing added successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
                dispose();
            } else {
                JOptionPane.showMessageDialog(this, "Failed to add Wine-Food Pairing!", "Error", JOptionPane.ERROR_MESSAGE);
            }
        } catch (Exception e) {
            handleError("Error adding Wine-Food Pairing", e);
        }
    }
