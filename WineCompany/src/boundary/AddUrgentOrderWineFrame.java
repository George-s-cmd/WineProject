...
public class AddUrgentOrderWineFrame extends JFrame {
    ...
    public AddUrgentOrderWineFrame() {
        setTitle("Add Pir");
        setSize(800, 600);
        ...
        addInputField("Urgent Order:", cbUrgentOrder, gbc, backgroundPanel, 1);
        ...
        // ✅ Button Actions
        btnAdd.addActionListener(e -> addUrgentOrderToWine());
    ...
    private void loadWines() {
        ...
        ArrayList<String> wines = GeneralControl.getInstance().getAllWineIdsFromWineTable();
    ...
    private void addUrgentOrderToWine() {
        try {
            ...
            boolean success = GeneralControl.getInstance().addUrgentOrderToWine(selectedOrderId, selectedWineId, quantity);

            if (success) {
                JOptionPane.showMessageDialog(this, "Urgent Order linked to Wine successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
                dispose();
            } else {
                JOptionPane.showMessageDialog(this, "Failed to link Urgent Order to Wine!", "Error", JOptionPane.ERROR_MESSAGE);
            }
        } catch (Exception e) {
